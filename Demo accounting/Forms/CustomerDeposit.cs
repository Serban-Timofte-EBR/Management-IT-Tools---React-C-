    ...
    public partial class CustomerDeposit : MetroFramework.Forms.MetroForm
    {
        ...
        private void Save_bt_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                OleDbDataAdapter da = new OleDbDataAdapter("Insert into [CustomerDepositTbl] (CustomerName,DepositDate,TotalAmt,CashAmt,BalanceAmt) values('" + cbCustomer.Text + "' ,'" + metroDateTime1.Value.ToShortDateString() + "' ," + txtTotalAmt.Text + "," + txtCash.Text + "," + txtBalance.Text + "  ) ", con);
                DataTable dt = new DataTable();
                da.Fill(dt);
